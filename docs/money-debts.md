...
The opening and every repayment independently choose whether Account money moved. This supports both exact Account bookkeeping and track-only historical or off-ledger debts.
...
Repayments are append-only settlement records with their own positive amount, date, optional note, optional Account movement, and protected transaction link. A repayment cannot precede the Debt opening date, occur in the future, or exceed the remaining balance.

Forgive balance records the complete remaining amount as Forgiveness without moving Account money. Removing a repayment or Forgiveness record reopens the Debt by that exact amount. A Debt can be deleted only before it has settlement history; deletion also reverses its optional opening Account movement.
...
Debts remain global, work during Season intermissions, and never affect SP, Rank, or Daily Progress.
