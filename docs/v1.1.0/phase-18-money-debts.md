...
Phase 18 adds Person-linked payable and receivable agreements, optional Account movements, partial repayment history, due dates, forgiveness, derived settlement state, Debt-aware Transaction History, and Account activity reporting. The detailed current contract is documented in [Money debts](../money-debts.md).
...
Coverage verifies both debt directions, tracked and track-only openings, partial repayments, Account changes, currency and date boundaries, overpayment rejection, forgiveness, reversal, transaction protection, ownership, page data, statistics isolation, format-2 round trips, and format-1 restoration.
