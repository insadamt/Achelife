    ...
    public function definitions(?int $formatVersion = null): array
    {
        ...
        return [
            ...
            $this->table(
                'task_series',
                'tasks',
                ['id', 'user_id', 'task_project_id', 'title', 'notes', 'important', 'recurrence_type', 'weekdays', 'subtask_template', 'starts_on', 'ends_before', 'materialized_through', 'created_at', 'updated_at'],
                $formatVersion >= 4 ? ['task_project_id' => 'task_projects'] : [],
            ),
            ...
            $this->table(
                'tasks',
                'tasks',
                ['id', 'user_id', 'task_series_id', 'task_project_id', 'title', 'notes', 'position', 'scheduled_date', 'occurrence_date', 'important', 'recurrence_type_snapshot', 'recurrence_weekdays_snapshot', 'completed_at', 'completion_timing', 'importance_at_completion', 'earned_sp', 'reward_season_id', 'created_at', 'updated_at'],
                ['task_series_id' => 'task_series', 'reward_season_id' => 'seasons', ...($formatVersion >= 4 ? ['task_project_id' => 'task_projects'] : [])],
            ),
            ...
            ...($formatVersion >= 5 ? [
                $this->table('task_focus_sessions', 'tasks', ['id', 'user_id', 'task_id', 'started_at', 'ended_at', 'accumulated_seconds', 'state', 'source', 'active_marker', 'created_at', 'updated_at'], ['task_id' => 'tasks']),
                $this->child('task_focus_intervals', 'tasks', ['id', 'task_focus_session_id', 'started_at', 'ended_at', 'created_at', 'updated_at'], 'task_focus_sessions', 'task_focus_session_id'),
            ] : []),
            $this->table('habits', 'habits', ['id', 'user_id', 'name', 'icon', 'type', 'unit', 'starts_on', 'synchronized_through', 'current_streak', 'inactive_on', 'archived_at', 'deleted_at', 'created_at', 'updated_at']),
