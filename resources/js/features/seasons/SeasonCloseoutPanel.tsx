        ...
        <div className="space-y-6">
            ...
            <section>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Surface className="p-5"><CheckCircle2 className="text-accent-ink" size={20} /><p className="mt-3 font-bold">Derived, not duplicated</p><p className="mt-1 text-sm leading-6 text-muted">This recap reads the final authoritative module records.</p></Surface>
                </div>
            </section>
