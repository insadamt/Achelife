...
export function BrandMark({ compact = false }: BrandMarkProps) {
    return (
        <Link
            ...
            href="/home"
        >
            <span className="relative grid size-9 place-items-center rounded-xl border border-[color-mix(in_srgb,var(--accent)_40%,var(--border-subtle))] bg-[color-mix(in_srgb,var(--accent)_8%,var(--surface-elevated))] text-sm font-black text-accent-ink">
                A
