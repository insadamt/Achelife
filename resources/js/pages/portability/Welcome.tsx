    ...
    return (
        <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
                ...
                <Surface className="p-5"><CalendarCheck className="text-accent-ink" size={20} /><p className="mt-4 text-sm text-muted">Current state</p><p className="text-xl font-bold">{summary.activeSeasonContinues ? 'Season continues' : 'Restore intermission'}</p><p className="text-sm text-secondary">Season {summary.heldSeasonNumber} waits for you.</p></Surface>
                <Surface className="p-5"><Trophy className="text-accent-ink" size={20} /><p className="mt-4 text-sm text-muted">Catch-up</p><p className="text-xl font-bold">Through original Day 30</p><p className="text-sm text-secondary">Timezone: {summary.timezone}</p></Surface>
            </div>
